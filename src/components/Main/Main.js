...
export default function Main() {
  ...
  const [certificationTitleRef, certificationTitleInView] = useInView({
    triggerOnce: true,
    threshold: 0.05,
  });

  const [certificationTextRef, certificationTextInView] = useInView({
    triggerOnce: true,
    threshold: 0.06,
  });
  ...
  return (
    <>
      <div className="small_text px-2 default_padding_top" id="about">
        <div className="card-section">
          <motion.h2
            ...
            ref={aboutTitleRef}
            initial="offscreen"
            animate={aboutTitleInView ? "onscreen" : "offscreen"}
          ...
          <motion.p
            ...
            ref={aboutTextRef}
            initial="offscreen"
            animate={aboutTextInView ? "onscreen" : "offscreen"}
            variants={slideUpVariants}
          >
      ...
      <div className="certifications-section small_text default_padding_top">
        <motion.h2
          className="text-center heading shadowed_text"
          style={{ fontSize: "2rem" }}
          ref={certificationTitleRef}
          initial="offscreen"
          animate={certificationTitleInView ? "onscreen" : "offscreen"}
          variants={slideUpVariants}
        >
          Certifications
        </motion.h2>
        <motion.p
          ...
          initial="offscreen"
          animate={certificationTextInView ? "onscreen" : "offscreen"}
          variants={slideUpVariants}
        >
